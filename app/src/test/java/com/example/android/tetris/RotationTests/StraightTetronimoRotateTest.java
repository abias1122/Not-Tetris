...
/**
 * Test rotation of StraightTetronimo
 */

public class StraightTetronimoRotateTest {
    private Gameboard gameboard;
    private StraightTetronimo testTetronimo;

    @Before
    public void before() {
        gameboard = new Gameboard();
        testTetronimo = new StraightTetronimo(gameboard);
    }

    /*0 degree to 90 degree tests*/
    @Test
    public void normalCaseZeroDeg(){
        int[][] initCoords = {{1, 3}, {2, 3}, {3, 3}, {4, 3}};
        int[] initAxisCoords = {3, 3};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.rotate();

        int[][] expectedCoordsArr = {{3, 1}, {3, 2}, {3, 3}, {3, 4}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalZeroDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{3, 0}, {3, 1}, {3, 3}, {3, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalZeroDegRotate2(){
        ...
        int[][] initCoords = {{0, 2}, {1, 2}, {2, 2}, {3, 2}};
        int[] initAxisCoords = {2, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.rotate();

        int[][] expectedCoordsArr = {{2, 3}, {2, 4}, {2, 2}, {2, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalZeroDegRotate3(){
        ...
        int[][] initCoords = {{0, 1}, {1, 1}, {2, 1}, {3, 1}};
        int[] initAxisCoords = {2, 1};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.rotate();

        int[][] expectedCoordsArr = {{2, 4}, {2, 3}, {2, 1}, {2, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noZeroDegRotate(){
        ...
        int[][] expectedCoordsArr = {{0, 1}, {1, 1}, {2, 1}, {3, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void normalCaseNinetyDeg(){
        int[][] initCoords = {{1, 0}, {1, 1}, {1, 2}, {1, 3}};
        ...
        int[][] expectedCoordsArr = {{3, 2}, {2, 2}, {1, 2}, {0, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalNinetyDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{4, 2}, {3, 2}, {1, 2}, {2, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalNinetyDegRotate2(){
        ...
        int[][] initCoords = {{2, 0}, {2, 1}, {2, 2}, {2, 3}};
        int[] initAxisCoords = {2, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.setCurrentState(Tetronimo.RotState.NINETY_DEG);
        ...
        int[][] expectedCoordsArr = {{1, 2}, {0, 2}, {2, 2}, {3, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalNinetyDegRotate3(){
        ...
        int[][] initCoords = {{3, 0}, {3, 1}, {3, 2}, {3, 3}};
        int[] initAxisCoords = {3, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.setCurrentState(Tetronimo.RotState.NINETY_DEG);
        testTetronimo.rotate();

        int[][] expectedCoordsArr = {{0, 2}, {1, 2}, {3, 2}, {2, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noNinetyDegRotate(){
        ...
        int[][] expectedCoordsArr = {{3, 0}, {3, 1}, {3, 2}, {3, 3}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void normalCaseOneEightyDeg(){
        ...
        int[][] expectedCoordsArr = {{1, 0}, {1, 1}, {1, 2}, {1, 3}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalOneEightyDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{1, 2}, {1, 1}, {1, 3}, {1, 4}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalOneEightyDegRotate2(){
        gameboard.getGridCell(1, 4).setOccupied(true);
        ...
        int[][] expectedCoordsArr = {{1, 3}, {1, 2}, {1, 1}, {1, 0}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalOneEightyDegRotate3(){
        ...
        int[][] initCoords = {{0, 3}, {1, 3}, {2, 3}, {3, 3}};
        int[] initAxisCoords = {1, 3};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.setCurrentState(Tetronimo.RotState.ONE_EIGHTY_DEG);
        testTetronimo.rotate();

        int[][] expectedCoordsArr = {{1, 2}, {1, 3}, {1, 1}, {1, 0}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noOneEightyDegRotate(){
        ...
        int[][] expectedCoordsArr = {{0, 3}, {1, 3}, {2, 3}, {3, 3}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalTwoSeventyDegRotate1(){
        gameboard.getGridCell(4, 1).setOccupied(true);
        ...
        int[][] expectedCoordsArr = {{2, 1}, {3, 1}, {1, 1}, {0, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalTwoSeventyDegRotate2(){
        ...
        int[][] expectedCoordsArr = {{1, 1}, {2, 1}, {3, 1}, {4, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalTwoSeventyDegRotate3(){
        ...
        int[][] expectedCoordsArr = {{2, 1}, {1, 1}, {3, 1}, {4, 1}};
