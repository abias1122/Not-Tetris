...
/**
 * Test rotation of LTetronimo
 */

public class LTetronimoRotateTest {
    private Gameboard gameboard;
    private LTetronimo testTetronimo;

    @Before
    public void before() {
        gameboard = new Gameboard();
        testTetronimo = new LTetronimo(gameboard);
    }

    /*0 degree to 90 degree tests*/
    @Test
    public void normalCaseZeroDeg(){
        int[][] initCoords = {{1, 2}, {2, 2}, {3, 2}, {3, 1}};
        ...
        int[][] expectedCoordsArr = {{2, 3}, {2, 2}, {3, 3}, {2, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalZeroDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{2, 4}, {2, 2}, {2, 3}, {3, 4}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalZeroDegRotate2(){
        ...
        int[][] expectedCoordsArr = {{2, 0}, {2, 2}, {3, 2}, {2, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noZeroDegRotate(){
        ...
        int[][] expectedCoordsArr = {{1, 2}, {2, 2}, {3, 2}, {3, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void normalCaseNinetyDeg(){
        int[][] initCoords = {{1, 1}, {1, 2}, {1, 3}, {2, 3}};
        ...
        int[][] expectedCoordsArr = {{0, 2}, {1, 2}, {0, 3}, {2, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalNinetyDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{2, 2}, {1, 2}, {1, 3}, {3, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalNinetyDegRotate2(){
        ...
        int[][] initCoords = {{2, 1}, {2, 2}, {2, 3}, {3, 3}};
        int[] initAxisCoords = {2, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        testTetronimo.setCurrentState(Tetronimo.RotState.NINETY_DEG);
        ...
        int[][] expectedCoordsArr = {{1, 2}, {2, 2}, {0, 2}, {0, 3}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noNinetyDegRotate(){
        ...
        int[][] expectedCoordsArr = {{2, 1}, {2, 2}, {2, 3}, {3, 3}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void normalCaseOneEightyDeg(){
        int[][] initCoords = {{1, 2}, {1, 3}, {2, 2}, {3, 2}};
        int[] initAxisCoords = {2, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        ...
        int[][] expectedCoordsArr = {{1, 1}, {2, 3}, {2, 2}, {2, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalOneEightyDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{2, 0}, {1, 0}, {2, 2}, {2, 1}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalOneEightyDegRotate2(){
        ...
        int[][] expectedCoordsArr = {{1, 2}, {2, 3}, {2, 2}, {2, 4}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noOneEightyDegRotate(){
        ...
        int[][] expectedCoordsArr = {{1, 2}, {1, 3}, {2, 2}, {3, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void normalCaseTwoSeventyDeg(){
        int[][] initCoords = {{1, 1}, {2, 1}, {2, 2}, {2, 3}};
        int[] initAxisCoords = {2, 2};
        testTetronimo.setComponentCells(initCoords);
        testTetronimo.setAxisCell(initAxisCoords);
        ...
        int[][] expectedCoordsArr = {{1, 2}, {3, 1}, {2, 2}, {3, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalTwoSeventyDegRotate1(){
        ...
        int[][] expectedCoordsArr = {{4, 1}, {3, 2}, {2, 2}, {4, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void abnormalTwoSeventyDegRotate2(){
        ...
        int[][] expectedCoordsArr = {{0, 2}, {2, 1}, {2, 2}, {1, 2}};
...
//        GeneralHelpers.printArray(actualCoordsArr);
    ...
    public void noTwoSeventyDegRotate(){
        ...
        int[][] expectedCoordsArr = {{1, 1}, {2, 1}, {2, 2}, {2, 3}};
