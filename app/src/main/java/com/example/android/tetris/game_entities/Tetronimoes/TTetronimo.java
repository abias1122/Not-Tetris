        ...
        switch (mCurrentState) {
            ...
            case NINETY_DEG: {
                ...
                if(axisXPos == 0 ||
                    ...
                    Log.i(TAG, "Cell left of axis occupied: " + mGameGridCells[(axisYPos * NUM_COLS) + (axisXPos - 1)].getOccupied());
                    useNormalRotate = false;
                }
            ...
            case ONE_EIGHTY_DEG: {
                ...
                if(axisYPos > 0 ||
                        mGameGridCells[((axisYPos - 1) * NUM_COLS) + axisXPos].getOccupied()) {
                    Log.i(TAG, "Cell above axis occupied: " + mGameGridCells[((axisYPos - 1) * NUM_COLS) + axisXPos].getOccupied());
                    useNormalRotate = false;
                }
            ...
            case TWO_SEVENTY_DEG: {
                ...
                if(mAxisCell.getXPos() == (NUM_COLS - 1) ||
                        mGameGridCells[(axisYPos * NUM_COLS) + (axisXPos + 1)].getOccupied()) {
                    Log.i(TAG, "Cell right of axis occupied: " + mGameGridCells[(axisYPos * NUM_COLS) + (axisXPos + 1)].getOccupied());
